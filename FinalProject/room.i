...
void drawItemText();
# 5 "room.c" 2
# 1 "room1_collisionMap.h" 1
# 21 "room1_collisionMap.h"
extern const unsigned short room1_collisionMapBitmap[19200];


extern const unsigned short room1_collisionMapPal[256];
# 6 "room.c" 2
# 1 "room2_collisionMap.h" 1
# 21 "room2_collisionMap.h"
extern const unsigned short room2_collisionMapBitmap[19200];


extern const unsigned short room2_collisionMapPal[256];
# 7 "room.c" 2
# 1 "room3_collisionMap.h" 1
# 21 "room3_collisionMap.h"
extern const unsigned short room3_collisionMapBitmap[19200];


extern const unsigned short room3_collisionMapPal[256];
# 8 "room.c" 2
# 1 "room4_collisionMap.h" 1
# 21 "room4_collisionMap.h"
extern const unsigned short room4_collisionMapBitmap[19200];


extern const unsigned short room4_collisionMapPal[256];
# 9 "room.c" 2
# 1 "roomsMusic.h" 1


extern const unsigned int roomsMusic_sampleRate;
extern const unsigned int roomsMusic_length;
extern const signed char roomsMusic_data[];
# 10 "room.c" 2
# 1 "level2Music.h" 1
...
void drawPlayer3() {
   ...
   if (player.hide) {
        ...
        shadowOAM[shadowOAMIndex].attr0 = ((player.worldRow)) | (0<<14);
        shadowOAM[shadowOAMIndex].attr1 = ((player.worldCol)) | (1<<14);
        shadowOAM[shadowOAMIndex].attr2 = ((0)<<12) | ((player.curFrame * 2)*32+(player.aniState * 2));
        shadowOAMIndex++;
    }
}
void updatePlayer3(){
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) {
        if (player.worldRow - player.rdel >= 0
            && collisionMap[((player.worldRow - player.rdel)*(240)+(player.worldCol))]
            && collisionMap[((player.worldRow - player.rdel)*(240)+(player.worldCol + player.width - 1))]) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if ((player.worldRow + player.rdel + player.height <= 160) &&
            collisionMap[((player.worldRow + player.height+player.rdel - 1)*(240)+(player.worldCol))] &&
            collisionMap[((player.worldRow + player.height+player.rdel - 1)*(240)+(player.worldCol + player.width - 1))]) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        if ((player.worldCol + player.cdel >= 0) &&
            collisionMap[((player.worldRow)*(240)+(player.worldCol - player.cdel))] &&
            collisionMap[((player.worldRow + player.height - 1)*(240)+(player.worldCol - player.cdel))]){
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        if ((player.worldCol + player.cdel + player.width <= 240) &&
            collisionMap[((player.worldRow)*(240)+(player.worldCol + player.width + player.cdel - 1))] &&
            collisionMap[((player.worldRow + player.height - 1)*(240)+(player.worldCol + player.width + player.cdel - 1))]) {
    ...
    if (collisionMap[((player.worldRow)*(240)+(player.worldCol))] == 2) {
        stopSound();
    ...
    if (collision(player.worldCol, player.worldRow, player.width, player.height,
            npc.worldCol, npc.worldRow, npc.width, npc.height) && (~((*(volatile unsigned short *)0x04000130)) & ((1<<0)))) {
            textCheck = 1;
...
void drawNPCRoom() {
    ...
    if (npc.hide) {
        ...
        if (roomCheck == 0) {
            shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
            shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
            shadowOAM[shadowOAMIndex].attr2 = ((1)<<12) | ((16)*32+(0));
            shadowOAMIndex++;
        }
        if (roomCheck == 1) {
            if ((prevCol >= 460)) {
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((2)<<12) | ((18)*32+(2));
                shadowOAMIndex++;
            } else if ((prevCol >= 300) && (prevCol <= 320)) {
                houseCheck = 21;
                npc.worldCol = 180;
                npc.worldRow = 100;
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((1)<<12) | ((20)*32+(2));
                shadowOAMIndex++;
            }
            else if (prevRow <= 235) {
                houseCheck = 23;
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((4)<<12) | ((16)*32+(2));
                shadowOAMIndex++;
            }
            else {
                npc.hide = 1;
        ...
        if (roomCheck == 2) {
            if ((prevRow >= 350) && (prevRow <= 360)) {
                houseCheck = 25;
                npc.worldCol = 90;
                npc.worldRow = 50;
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((4)<<12) | ((22)*32+(2));
                shadowOAMIndex++;
            } else if ((prevRow <= 328) && (prevRow >= 318)) {
                houseCheck = 27;
                npc.worldCol = 30;
                npc.worldRow = 20;
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
            ...
            else if ((prevCol <= 185) && (prevRow >= 428)) {
                houseCheck = 29;
                npc.worldCol = 120;
                npc.worldRow = 70;
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
        ...
        if (roomCheck == 3) {
            if ((prevRow - 190) <= 10) {
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((4)<<12) | ((24)*32+(0));
                shadowOAMIndex++;
            } else if ((prevRow - 350) <= 10 && (prevCol >= 415)){
                if (gaveFlowers == 0) {
                    houseCheck = 10;
            ...
            } else if ((prevRow - 350) <= 10 && (prevCol <= 80)){
                if (chickensLeft > 2) {
                    houseCheck = 12;
                }
                else {
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((1)<<12) | ((18)*32+(0));
                shadowOAMIndex++;

            } else if (foregroundCheck == 0 && (prevCol >= 365) && keyObtained == 1){
                havePotion = 1;
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((4)<<12) | ((20)*32+(0));
                shadowOAMIndex++;

            }
            else if (foregroundCheck == 0 && (prevCol <= 95)){
                if (haveEggs == 0) {
                    houseCheck = 16;
                } else if (haveEggs == 1) {
                ...
                shadowOAM[shadowOAMIndex].attr0 = (npc.worldRow) | (0<<14);
                shadowOAM[shadowOAMIndex].attr1 = (npc.worldCol) | (1<<14);
                shadowOAM[shadowOAMIndex].attr2 = ((1)<<12) | ((22)*32+(0));
                shadowOAMIndex++;
